  ...
  return <div className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-50 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          {/* Logo */}
          <div className="mb-10">
            <span className="text-2xl font-bold">the Examiner
          </span>
          </div>
          
          {/* Welcome text */}
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Welcome back,<br />Olivia!</h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div>
                ...
                <Input id="email" type="email" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} required className="w-full" />
              </div>
              ...
              <div>
                ...
                <Input id="password" type="password" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} required className="w-full" />
              </div>
